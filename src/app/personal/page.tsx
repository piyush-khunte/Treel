...
export default function PersonalPage() {
  return (
    <div className="bg-white text-[#111827] font-manrope selection:bg-[#2563EB]/10 selection:text-[#2563EB]">
      {/* Hero Section */}
      <section className="relative overflow-hidden pt-16 pb-20 sm:pt-20 sm:pb-28 border-b border-[#F3F4F6] bg-gradient-to-b from-white to-[#F3F4F6]/50">
        <div className="max-w-[1440px] mx-auto px-4 sm:px-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            {/* Left Hero Content */}
            <div className="lg:col-span-7 space-y-6">
              <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full border border-[#2563EB]/20 bg-[#2563EB]/5 text-[#2563EB] font-manrope text-xs font-semibold uppercase tracking-wider">
              ...
              <h1 className="font-manrope text-5xl sm:text-6xl lg:text-7xl font-extrabold tracking-tight text-[#111827] leading-[1.05]">
                Know before <span className="italic text-[#2563EB]">you go.</span>
              </h1>

              <p className="text-[#6B7280] text-lg sm:text-xl leading-relaxed font-manrope font-normal max-w-2xl">
              ...
              <div className="flex flex-wrap items-center gap-4 pt-2">
                <Link
                  href="/personal/buy"
                  className="inline-flex items-center gap-2 px-7 py-3.5 rounded-xl font-manrope font-bold text-base transition-all shadow-md bg-[#2563EB] text-white hover:bg-[#1D4ED8] active:scale-[0.98]"
                >
                  Buy for ₹8,999 <ArrowRight className="w-5 h-5" />
                </Link>
                <Link
                  href="/personal/features"
                  className="inline-flex items-center gap-2 px-7 py-3.5 rounded-xl font-manrope font-semibold text-base transition-all border border-[#E5E7EB] text-[#111827] bg-white hover:bg-[#F3F4F6] active:scale-[0.98]"
                >
                  Explore Features
                </Link>
              </div>
            ...
            <div className="lg:col-span-5 flex justify-center">
              <div className="w-full max-w-sm rounded-3xl bg-white border-2 border-[#E5E7EB] p-6 shadow-2xl space-y-6">
                <div className="flex items-center justify-between border-b border-[#F3F4F6] pb-4">
                  <div>
                    ...
                    <div className="font-manrope text-base font-bold text-[#111827]">Priya · Honda City</div>
                  </div>
                ...
                <div className="grid grid-cols-2 gap-4 py-2">
                  <div className="p-4 rounded-2xl bg-[#F3F4F6] border border-[#E5E7EB] text-center space-y-1">
                    <div className="text-[11px] font-semibold text-[#6B7280] uppercase">Front Left</div>
                    <div className="font-manrope text-2xl font-bold text-[#111827]">32 <span className="text-xs font-normal text-[#6B7280]">PSI</span></div>
                    <div className="text-[11px] font-medium text-[#10B981]">31°C · Optimal</div>
                  </div>

                  <div className="p-4 rounded-2xl bg-[#F3F4F6] border border-[#E5E7EB] text-center space-y-1">
                    <div className="text-[11px] font-semibold text-[#6B7280] uppercase">Front Right</div>
                    <div className="font-manrope text-2xl font-bold text-[#111827]">32 <span className="text-xs font-normal text-[#6B7280]">PSI</span></div>
                    <div className="text-[11px] font-medium text-[#10B981]">31°C · Optimal</div>
                  </div>

                  <div className="p-4 rounded-2xl bg-[#F3F4F6] border border-[#E5E7EB] text-center space-y-1">
                    <div className="text-[11px] font-semibold text-[#6B7280] uppercase">Rear Left</div>
                    <div className="font-manrope text-2xl font-bold text-[#111827]">33 <span className="text-xs font-normal text-[#6B7280]">PSI</span></div>
                    <div className="text-[11px] font-medium text-[#10B981]">32°C · Optimal</div>
                  </div>

                  <div className="p-4 rounded-2xl bg-[#F3F4F6] border border-[#E5E7EB] text-center space-y-1">
                    <div className="text-[11px] font-semibold text-[#6B7280] uppercase">Rear Right</div>
                    <div className="font-manrope text-2xl font-bold text-[#111827]">33 <span className="text-xs font-normal text-[#6B7280]">PSI</span></div>
                    <div className="text-[11px] font-medium text-[#10B981]">32°C · Optimal</div>
                  </div>
                </div>

                <div className="p-3 rounded-xl bg-[#2563EB]/5 border border-[#2563EB]/20 text-center">
      ...
      <section className="py-20 border-b border-[#F3F4F6] bg-white">
        <div className="max-w-[1440px] mx-auto px-4 sm:px-10">
          <div className="max-w-3xl mb-14">
            <div className="inline-block font-manrope text-xs font-bold uppercase tracking-widest text-[#2563EB] mb-2">
              WHY PERSONAL TPMS
            </div>
            <h2 className="font-manrope text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight text-[#111827]">
              Safety, without the noise.
            </h2>
            <p className="text-[#6B7280] text-lg mt-3 leading-relaxed font-normal">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((item) => {
              ...
              return (
                <div
                  key={item.title}
                  className="p-8 rounded-2xl bg-[#F3F4F6]/60 border border-[#E5E7EB] hover:border-[#2563EB]/40 transition-all space-y-4"
                >
                  <div className="w-12 h-12 rounded-xl bg-white border border-[#E5E7EB] flex items-center justify-center text-[#2563EB] shadow-sm">
      ...
      {/* Specs at a Glance */}
      <section className="py-20 border-b border-[#F3F4F6] bg-[#F3F4F6]/40">
        <div className="max-w-[1440px] mx-auto px-4 sm:px-10">
          <div className="max-w-3xl mb-12">
            <div className="inline-block font-manrope text-xs font-bold uppercase tracking-widest text-[#2563EB] mb-2">
              SPECS AT A GLANCE
            </div>
            <h2 className="font-manrope text-3xl sm:text-4xl font-bold tracking-tight text-[#111827]">
              The details, briefly.
            </h2>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-[1440px] mx-auto px-4 sm:px-10">
          <div className="p-10 sm:p-16 rounded-3xl bg-[#F3F4F6] border border-[#E5E7EB] text-center max-w-4xl mx-auto space-y-6">
            <div className="inline-block font-manrope text-xs font-bold uppercase tracking-widest text-[#2563EB]">
              READY TO DRIVE SAFE
            </div>
            ...
            <div className="flex items-baseline justify-center gap-3 pt-2">
              <span className="font-manrope text-4xl sm:text-5xl font-extrabold text-[#111827]">
                ₹8,999
              </span>
              <span className="text-[#6B7280] line-through text-lg font-medium">
                ₹12,999
              </span>
            ...
            <div className="pt-4 flex justify-center">
              <Link
                href="/personal/buy"
                className="inline-flex items-center gap-2 px-8 py-4 rounded-xl font-manrope font-bold text-base transition-all shadow-md bg-[#2563EB] text-white hover:bg-[#1D4ED8] active:scale-[0.98]"
              >
