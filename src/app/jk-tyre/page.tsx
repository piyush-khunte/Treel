          ...
          <div className="max-w-4xl space-y-8">
            ...
            <div className="space-y-4">
              <div className="p-6 rounded-xl bg-white/[0.03] border border-white/10 flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-base text-[#FAF7F2]">Not a business unit of JK Tyre</h3>
              ...
              <div className="p-6 rounded-xl bg-white/[0.03] border border-white/10 flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-base text-[#FAF7F2]">Not JK Tyre&apos;s marketing arm</h3>
                  <p className="text-sm text-[#94A3B8] mt-1 leading-relaxed">
              ...
              <div className="p-6 rounded-xl bg-white/[0.03] border border-white/10 flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-base text-[#FAF7F2]">Not restricted to JK Tyre customers</h3>
                  <p className="text-sm text-[#94A3B8] mt-1 leading-relaxed">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="p-6 rounded-2xl bg-white/[0.03] border border-white/10 space-y-3 flex flex-col justify-between">
                <div>
                  ...
                  <h3 className="font-fraunces text-lg font-bold text-[#FAF7F2]">For Fleet Operators</h3>
              ...
              <div className="p-6 rounded-2xl bg-white/[0.03] border border-white/10 space-y-3 flex flex-col justify-between">
                <div>
                  ...
                  <h3 className="font-fraunces text-lg font-bold text-[#FAF7F2]">For Partners &amp; OEMs</h3>
                  <p className="text-xs sm:text-sm text-[#94A3B8] mt-2 leading-relaxed">
              ...
              <div className="p-6 rounded-2xl bg-white/[0.03] border border-white/10 space-y-3 flex flex-col justify-between">
                <div>
                  ...
                  <h3 className="font-fraunces text-lg font-bold text-[#FAF7F2]">For Candidates</h3>
                  <p className="text-xs sm:text-sm text-[#94A3B8] mt-2 leading-relaxed">
        ...
        <div className="max-w-[1440px] mx-auto px-4 sm:px-10">
          <div className="max-w-4xl space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
              <Link href="/about" className="p-6 rounded-xl bg-white/[0.03] border border-white/10 hover:border-[#D5573B]/40 transition-all group block">
                <h3 className="font-fraunces text-lg font-bold text-[#FAF7F2] group-hover:text-[#D5573B] transition-colors">About Treel</h3>
              ...
              <Link href="/our-story" className="p-6 rounded-xl bg-white/[0.03] border border-white/10 hover:border-[#D5573B]/40 transition-all group block">
                <h3 className="font-fraunces text-lg font-bold text-[#FAF7F2] group-hover:text-[#D5573B] transition-colors">Our story</h3>
              ...
              >
                <h3 className="font-fraunces text-lg font-bold text-[#FAF7F2] group-hover:text-[#D5573B] transition-colors flex items-center gap-1.5">
