  ...
  return (
    <div className="space-y-0 bg-[#111927] text-[#FAF7F2] font-inter">
      ...
      <section className="py-12 border-b border-white/10 bg-white/[0.02]">
        <div className="max-w-[1440px] mx-auto px-4 sm:px-10">
          <div className="max-w-4xl p-8 rounded-2xl bg-[#1C2541]/40 border border-[#D5573B]/30 space-y-3">
            <div className="text-xs font-mono uppercase tracking-widest text-[#D5573B] font-bold">
              AT A GLANCE
            </div>
        ...
        <div className="max-w-[1440px] mx-auto px-4 sm:px-10">
          <div className="max-w-4xl space-y-8">
            ...
            <div className="space-y-6">
              <div className="p-6 rounded-xl bg-white/[0.03] border border-white/10 flex items-start gap-5">
                <div className="w-10 h-10 rounded-full bg-[#D5573B]/10 border border-[#D5573B]/30 flex items-center justify-center font-mono text-sm font-bold text-[#D5573B] shrink-0">
                  01
                </div>
                <div>
                  <h3 className="font-fraunces text-xl font-bold text-[#FAF7F2]">Step 1 · Sensors report</h3>
              ...
              <div className="p-6 rounded-xl bg-white/[0.03] border border-white/10 flex items-start gap-5">
                ...
                <div>
                  <h3 className="font-fraunces text-xl font-bold text-[#FAF7F2]">Step 2 · The Twin updates</h3>
                  <p className="text-sm text-[#94A3B8] mt-2 leading-relaxed font-inter">
              ...
              <div className="p-6 rounded-xl bg-white/[0.03] border border-white/10 flex items-start gap-5">
                ...
                <div>
                  <h3 className="font-fraunces text-xl font-bold text-[#FAF7F2]">Step 3 · Operators query</h3>
                  <p className="text-sm text-[#94A3B8] mt-2 leading-relaxed font-inter">
          ...
          <div className="max-w-4xl space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 pt-4">
              <div className="p-6 rounded-xl bg-white/[0.03] border border-white/10 text-center">
                <div className="font-fraunces text-3xl font-bold text-[#D5573B]">5–7%</div>
                <div className="text-xs font-mono uppercase tracking-wider text-[#94A3B8] mt-2">Tyre Life Extension</div>
              </div>
              <div className="p-6 rounded-xl bg-white/[0.03] border border-white/10 text-center">
                <div className="font-fraunces text-3xl font-bold text-[#D5573B]">5–6%</div>
                <div className="text-xs font-mono uppercase tracking-wider text-[#94A3B8] mt-2">Direct Fuel Savings</div>
              </div>
              <div className="p-6 rounded-xl bg-white/[0.03] border border-white/10 text-center">
                <div className="font-fraunces text-3xl font-bold text-[#D5573B]">30–40%</div>
                <div className="text-xs font-mono uppercase tracking-wider text-[#94A3B8] mt-2">Downtime Reduction</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 border-b border-white/10">
        <div className="max-w-[1440px] mx-auto px-4 sm:px-10">
          <div className="max-w-4xl space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <Link href="/research/roi-fleet-intelligence" className="p-6 rounded-xl bg-white/[0.03] border border-white/10 hover:border-[#D5573B]/40 transition-all group block">
                <h3 className="font-fraunces text-lg font-bold text-[#FAF7F2] group-hover:text-[#D5573B] transition-colors">Read the technical whitepaper</h3>
              ...
              <Link href="/mobility-intelligence" className="p-6 rounded-xl bg-white/[0.03] border border-white/10 hover:border-[#D5573B]/40 transition-all group block">
                <h3 className="font-fraunces text-lg font-bold text-[#FAF7F2] group-hover:text-[#D5573B] transition-colors">What is mobility intelligence?</h3>
              ...
              <Link href="/tmip" className="p-6 rounded-xl bg-white/[0.03] border border-white/10 hover:border-[#D5573B]/40 transition-all group block">
                <h3 className="font-fraunces text-lg font-bold text-[#FAF7F2] group-hover:text-[#D5573B] transition-colors">Explore TMIP</h3>
