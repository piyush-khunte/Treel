        ...
        <div className="max-w-[1440px] mx-auto px-4 sm:px-10">
          <div className="max-w-4xl space-y-10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {metrics.map((m, idx) => (
                <div key={idx} className="p-6 rounded-2xl bg-white/[0.03] border border-white/10 space-y-2 flex flex-col justify-between">
                  <div className="font-fraunces text-3xl sm:text-4xl font-bold text-[#D5573B] tracking-tight">
                    {m.value}
                  </div>
                  <div>
                    <div className="font-fraunces text-sm font-semibold text-[#FAF7F2]">
                      {m.label}
                    </div>
      ...
      <section className="py-20 border-b border-white/10">
        <div className="max-w-[1440px] mx-auto px-4 sm:px-10">
          <div className="max-w-4xl space-y-10">
            ...
            <div className="w-full rounded-2xl bg-gradient-to-b from-white/[0.08] via-white/[0.03] to-white/[0.01] border border-white/10 p-6 sm:p-8 relative overflow-hidden shadow-2xl space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
                <div className="p-4 rounded-xl bg-white/[0.04] border border-white/10 space-y-2">
                  ...
                  <div className="text-xs font-bold text-[#FAF7F2]">01 · Wheel Sensors</div>
                ...
                <div className="p-4 rounded-xl bg-white/[0.04] border border-white/10 space-y-2">
                  ...
                  <div className="text-xs font-bold text-[#FAF7F2]">02 · Edge Gateway</div>
                ...
                <div className="p-4 rounded-xl bg-white/[0.04] border border-white/10 space-y-2">
                  ...
                  <div className="text-xs font-bold text-[#FAF7F2]">03 · Cloud Stream</div>
                ...
                <div className="p-4 rounded-xl bg-white/[0.04] border border-white/10 space-y-2">
                  ...
                  <div className="text-xs font-bold text-[#FAF7F2]">04 · Digital Twin</div>
                ...
                <div className="p-4 rounded-xl bg-white/[0.04] border border-white/10 space-y-2">
                  ...
                  <div className="text-xs font-bold text-[#FAF7F2]">05 · Fleet Action</div>
          ...
          <div className="max-w-4xl space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {privacyPillars.map((p, idx) => (
                <div key={idx} className="p-8 rounded-2xl bg-white/[0.03] border border-white/10 space-y-3 flex flex-col justify-between">
                  <div className="space-y-2">
                    ...
                    <h3 className="font-fraunces text-lg font-bold text-[#FAF7F2]">
                      {p.title}
                    </h3>
                  </div>
      ...
      <section className="py-20 border-b border-white/10 bg-white/[0.01]">
        <div className="max-w-[1440px] mx-auto px-4 sm:px-10">
          <div className="max-w-4xl">
            <div className="p-8 sm:p-10 rounded-2xl bg-white/[0.03] border border-white/10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6 shadow-xl">
              ...
              <Link
                ...
                className="inline-flex items-center gap-2 px-6 py-3 rounded-lg font-semibold text-sm transition-all shadow-md bg-[#D5573B] text-[#FAF7F2] hover:bg-[#CB4831] whitespace-nowrap"
              >
