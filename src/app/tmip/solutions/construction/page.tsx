        ...
        <div className="max-w-[1440px] mx-auto px-4 sm:px-10">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            <div className="p-6 rounded-2xl bg-[#0B1220] border border-white/10">
              <div className="font-space text-3xl sm:text-4xl font-bold text-[#10B981]">14% Lower</div>
              <div className="text-sm font-semibold text-[#F1F5F9] mt-1">Tyre Scrap Rate</div>
              <div className="text-xs text-[#94A3B8] mt-1">Preserving casing retreadability under harsh aggregate haulage</div>
            </div>
            <div className="p-6 rounded-2xl bg-[#0B1220] border border-white/10">
              <div className="font-space text-3xl sm:text-4xl font-bold text-[#3B82F6]">31% Drop</div>
              <div className="text-sm font-semibold text-[#F1F5F9] mt-1">Unscheduled Site Downtime</div>
              <div className="text-xs text-[#94A3B8] mt-1">Preventing mid-pour mixer breakdowns and paving stoppages</div>
            </div>
            <div className="p-6 rounded-2xl bg-[#0B1220] border border-white/10">
              <div className="font-space text-3xl sm:text-4xl font-bold text-[#F59E0B]">IP67 / ARAI</div>
              <div className="text-sm font-semibold text-[#F1F5F9] mt-1">Certified Ruggedised IoT</div>
              <div className="text-xs text-[#94A3B8] mt-1">Tested against dust immersion, washdown sprays, and shock</div>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-5 p-8 rounded-2xl bg-[#050A17] border border-white/10 space-y-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="font-space font-bold text-base text-[#F1F5F9]">Site Durability Metrics</div>
                  <div className="text-xs font-mono text-[#94A3B8]">Construction Field Benchmark</div>
                </div>
              </div>

              <div className="space-y-4 pt-2">
                <div className="flex items-center justify-between p-3 rounded-lg bg-white/[0.02] border border-white/5">
                  <span className="text-sm text-[#94A3B8]">Sensor Ingress Rating</span>
                  <span className="text-sm font-mono font-bold text-[#10B981]">IP67 Dust & Jet Wash</span>
                </div>
                <div className="flex items-center justify-between p-3 rounded-lg bg-white/[0.02] border border-white/5">
                  <span className="text-sm text-[#94A3B8]">Offline Edge Buffer</span>
                  <span className="text-sm font-mono font-bold text-[#3B82F6]">Up to 72 hrs on-chip</span>
                </div>
                <div className="flex items-center justify-between p-3 rounded-lg bg-white/[0.02] border border-white/5">
                  <span className="text-sm text-[#94A3B8]">Typical Payback Window</span>
                  <span className="text-sm font-mono font-bold text-[#F59E0B]">7.4 Months</span>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="p-8 rounded-2xl bg-[#050A17] border border-white/10 flex flex-col justify-between space-y-6">
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-xs font-mono text-[#94A3B8]">280 Tippers & Mixers</span>
                </div>
