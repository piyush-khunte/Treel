      ...
      <section className="py-20 border-b border-white/10">
        <div className="max-w-[1440px] mx-auto px-4 sm:px-10">
          <div className="max-w-4xl space-y-16">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-4 text-base sm:text-lg text-[#94A3B8] leading-relaxed">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-2">
                  <div className="p-5 rounded-xl bg-[#0B1220] border border-white/10 space-y-2">
                    <div className="font-mono text-xs text-[#3B82F6] font-bold">STAGE 01 · DAYS 1-30</div>
                    <div className="font-space font-bold text-[#F1F5F9]">Hardware Retrofit</div>
                  ...
                  <div className="p-5 rounded-xl bg-[#0B1220] border border-white/10 space-y-2">
                    <div className="font-mono text-xs text-[#3B82F6] font-bold">STAGE 02 · DAYS 31-60</div>
                    <div className="font-space font-bold text-[#F1F5F9]">TMS Integration</div>
                    <p className="text-xs text-[#94A3B8]">
                  ...
                  <div className="p-5 rounded-xl bg-[#0B1220] border border-white/10 space-y-2">
                    <div className="font-mono text-xs text-[#3B82F6] font-bold">STAGE 03 · DAYS 61-90</div>
                    <div className="font-space font-bold text-[#F1F5F9]">Digital Twin Activation</div>
                    <p className="text-xs text-[#94A3B8]">
            ...
            {/* Customer Quote */}
            <div className="p-8 sm:p-10 rounded-3xl bg-gradient-to-br from-[#0B1220] to-[#080E1E] border border-white/15 relative">
              <blockquote className="space-y-4">
                <p className="font-space text-xl sm:text-2xl text-[#F1F5F9] italic leading-relaxed">
                ...
                <footer className="pt-4 border-t border-white/10">
                  <div className="font-space font-bold text-[#F1F5F9]">Head of Fleet Engineering &amp; Maintenance</div>
                  <div className="text-xs font-mono text-[#3B82F6]">Tier-1 Pan-India Logistics Operator</div>
                </footer>
              </blockquote>
            </div>
