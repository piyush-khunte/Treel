              ...
              <div className="space-y-4 text-base sm:text-lg text-[#94A3B8] leading-relaxed">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-2">
                  <div className="p-4 rounded-xl bg-[#080E1E] border border-white/10 space-y-2">
                    <div className="text-xs font-mono font-bold text-[#3B82F6] uppercase">In-Cab Safety Telemetry</div>
                  ...
                  <div className="p-4 rounded-xl bg-[#080E1E] border border-white/10 space-y-2">
                    <div className="text-xs font-mono font-bold text-[#10B981] uppercase">Passenger Comfort Scoring</div>
                    <p className="text-xs text-[#94A3B8]">
