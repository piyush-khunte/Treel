    ...
    <div className="bg-[#050A17] text-[#F1F5F9] font-ibm">
              ...
              return (
                ...
                >
                  ...
                  <div className="pt-6 mt-6 border-t border-white/5 space-y-2">
                    {sub.metrics.map((m) => (
                      <div key={m} className="flex items-center gap-2 text-xs font-mono text-[#CBD5E1]">
        ...
        <div className="max-w-[1440px] mx-auto px-4 sm:px-10">
          <div className="max-w-4xl space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
              <div className="p-6 rounded-2xl bg-[#0B1220] border border-red-500/20 space-y-3">
              ...
              <div className="p-6 rounded-2xl bg-[#0B1220] border border-blue-500/30 space-y-3">
                <div className="flex items-center gap-2 text-[#3B82F6] font-mono text-xs font-semibold uppercase tracking-wider">
      ...
      <section className="py-20 border-b border-white/10">
        <div className="max-w-[1440px] mx-auto px-4 sm:px-10">
          ...
          <div className="p-6 sm:p-8 rounded-2xl bg-[#080E1E] border border-white/10 space-y-6">
            <div className="flex flex-wrap items-center justify-between gap-4 pb-4 border-b border-white/10">
              ...
              <div className="flex items-center gap-2 text-xs font-mono text-[#94A3B8]">
                <span className="px-2.5 py-1 rounded-md bg-[#0B1220] border border-white/10">Filter: All Regions</span>
                <span className="px-2.5 py-1 rounded-md bg-[#0B1220] border border-white/10">Sampling: 1000ms</span>
              </div>
            </div>

            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              <div className="p-4 rounded-xl bg-[#0B1220] border border-white/5">
                <div className="text-xs font-mono text-[#94A3B8] mb-1">Average Fleet Pressure</div>
                <div className="font-space text-2xl font-bold text-[#F1F5F9]">118.4 PSI</div>
                <div className="text-[11px] font-mono text-[#10B981] mt-1">98.6% in nominal band</div>
              </div>
              <div className="p-4 rounded-xl bg-[#0B1220] border border-white/5">
                <div className="text-xs font-mono text-[#94A3B8] mb-1">Wheel-End Temperature</div>
                <div className="font-space text-2xl font-bold text-[#F1F5F9]">54.2°C</div>
                <div className="text-[11px] font-mono text-[#10B981] mt-1">Normal highway thermal curve</div>
              </div>
              <div className="p-4 rounded-xl bg-[#0B1220] border border-white/5">
                <div className="text-xs font-mono text-[#94A3B8] mb-1">Telemetry Uptime</div>
                <div className="font-space text-2xl font-bold text-[#3B82F6]">99.8%</div>
                <div className="text-[11px] font-mono text-[#CBD5E1] mt-1">Edge buffer active</div>
              </div>
              <div className="p-4 rounded-xl bg-[#0B1220] border border-white/5">
                <div className="text-xs font-mono text-[#94A3B8] mb-1">Active Alerts</div>
                <div className="font-space text-2xl font-bold text-[#F59E0B]">3 Actionable</div>
                <div className="text-[11px] font-mono text-[#F59E0B] mt-1">0 critical roadside stops</div>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {alerts.map((al) => {
              ...
              return (
                <div
                  key={al.type}
                  className="p-6 rounded-2xl bg-[#0B1220] border border-white/10 hover:border-blue-500/30 transition-all flex flex-col justify-between space-y-6"
                >
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      ...
                      <span className={`text-[11px] font-mono font-semibold px-2.5 py-1 rounded-full border ${al.badgeColor}`}>
                        {al.badge}
                      </span>
                    </div>

                    <div>
                      <div className="text-xs font-mono text-[#3B82F6]">{al.vehicle}</div>
                      <h3 className="font-space text-xl font-bold text-[#F1F5F9] mt-1">
                        {al.type}
                      </h3>
                    </div>

                    <div className="p-3 rounded-lg bg-[#050A17] border border-white/5 font-mono text-xs text-[#CBD5E1]">
                      {al.reading}
                    </div>
                    ...
                    <div className="space-y-2 text-xs">
                      ...
                      <div>
                        ...
                        <span className="text-[#3B82F6] font-mono">{al.assigned}</span>
                      </div>
                    </div>
                  </div>
                </div>
