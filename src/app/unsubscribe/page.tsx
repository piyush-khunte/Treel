  ...
  return (
    <div className="space-y-0 bg-[#111927] text-[#FAF7F2] font-inter">
      <section className="relative overflow-hidden pt-24 pb-20 border-b border-white/10">
        <div className="max-w-[1440px] mx-auto px-4 sm:px-10">
          <div className="max-w-4xl space-y-6">
            <h1 className="font-fraunces text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight text-[#FAF7F2] leading-[1.15]">Unsubscribe</h1>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 border-b border-white/10">
        <div className="max-w-[1440px] mx-auto px-4 sm:px-10">
          <div className="max-w-4xl space-y-6">
            <p className="text-[#94A3B8] text-base sm:text-lg leading-relaxed font-inter">**Transactional emails cannot be unsubscribed:**</p>
      ...
      <section className="py-20 border-b border-white/10">
        <div className="max-w-[1440px] mx-auto px-4 sm:px-10">
          <div className="max-w-4xl space-y-6">
            <h2 className="font-fraunces text-2xl sm:text-3xl lg:text-4xl font-bold tracking-tight text-[#FAF7F2]">You've been unsubscribed.</h2>
            <p className="text-[#94A3B8] text-base sm:text-lg leading-relaxed font-inter">**Confirmation modal (for unsubscribe-all):**</p>
            ...
            <p className="text-[#94A3B8] text-base sm:text-lg leading-relaxed font-inter">**Success message (after save):**</p>
            ...
            <p className="text-[#94A3B8] text-base sm:text-lg leading-relaxed font-inter">**Success message (after unsubscribe-all):**</p>
