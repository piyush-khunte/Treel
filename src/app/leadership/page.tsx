      ...
      <section className="py-20 border-b border-white/10">
        <div className="max-w-[1440px] mx-auto px-4 sm:px-10">
          <div className="max-w-4xl">
            <div className="p-8 sm:p-12 rounded-2xl bg-white/[0.03] border border-white/10 grid grid-cols-1 md:grid-cols-12 gap-8 items-center shadow-xl">
              {/* Founder Portrait Visual Area */}
              <div className="md:col-span-5 flex flex-col items-center justify-center">
                <div className="w-full max-w-[280px] aspect-[4/5] rounded-xl bg-gradient-to-b from-white/[0.08] via-white/[0.03] to-white/[0.01] border border-white/15 relative overflow-hidden shadow-inner">
              ...
              <div className="md:col-span-7 space-y-5">
                <div className="space-y-1">
                  ...
                  <h2 className="font-fraunces text-3xl font-bold text-[#FAF7F2]">
                    Manish Ingale
                  </h2>
                  <div className="text-sm font-mono text-[#94A3B8]">Founder, Treel Mobility Solutions</div>
                </div>
          ...
          <div className="max-w-4xl space-y-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              {executives.map((exec, idx) => (
                <div key={idx} className="rounded-2xl bg-white/[0.03] border border-white/10 overflow-hidden flex flex-col justify-between shadow-sm">
                  {/* Photo Visual Area */}
                  <div className="w-full aspect-[4/5] bg-gradient-to-b from-white/[0.08] via-white/[0.03] to-white/[0.01] border-b border-white/10 relative overflow-hidden">
                    <div className="absolute inset-0 bg-white/5 opacity-40" />
                  </div>
                  ...
                  <div className="p-6 space-y-3">
                    <div>
                      ...
                      <div className="text-xs font-mono uppercase tracking-wider text-[#D5573B] mt-1 font-semibold">
                        {exec.role}
                      </div>
                    </div>
      ...
      <section className="py-20 border-b border-white/10">
        <div className="max-w-[1440px] mx-auto px-4 sm:px-10">
          <div className="max-w-4xl space-y-6">
            ...
            <div className="p-8 rounded-2xl bg-white/[0.03] border border-white/10 space-y-3">
      ...
      <section className="py-20 border-b border-white/10">
        <div className="max-w-[1440px] mx-auto px-4 sm:px-10">
          <div className="max-w-4xl space-y-4">
            <div className="w-full aspect-[21/9] sm:aspect-[24/9] rounded-2xl bg-gradient-to-r from-white/[0.06] via-white/[0.02] to-white/[0.06] border border-white/10 relative overflow-hidden flex items-end p-6">
              <div className="flex items-center gap-2 text-xs font-mono text-[#94A3B8] bg-[#111927]/80 backdrop-blur-sm px-3 py-1.5 rounded-md border border-white/10">
